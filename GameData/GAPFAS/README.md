...
The Groups.cfg file that comes with the mod is packaged as a file called Groups.cfg.0
This is done so that if a future update makes a change to the Groups.cfg information it 
